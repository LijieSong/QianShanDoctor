...
//        SDKInitializer.initialize(MyApplication.getContext());
	...
	public void initData() {
		title_bar.setTitleText(R.string.location_message);
	...
	public void setOnClick() {
		...
		title_bar.setRightBtnOnclickListener(new View.OnClickListener() {
			@Override
	...
	public void sendLocation() {
		...
		finish();
		overridePendingTransition(R.anim.cuntomanim, R.anim.cunexitmanim);
	}
	@Override
	...
	private void showMap(double latitude, double longtitude, String address) {
		title_bar.setRightBtnText("");
		title_bar.getRightBtn().setEnabled(false);
...
//		option.setCoorType("gcj02");
	...
	public class MyLocationListenner implements BDLocationListener {
		...
		public void onReceiveLocation(BDLocation location) {
			...
			LogUtils.error("map----On location change received:" + location);
			LogUtils.error("map---addr:" + location.getAddrStr());
			LogUtils.error("latitude:" + location.getLatitude() +"---longtitude:" +location.getLongitude()+"---address:" +location.getAddrStr()+"---cityCode:"+location.getCityCode()+"----city:"+location.getCity());
			title_bar.getRightBtn().setEnabled(true);
			title_bar.setRightBtnText(R.string.send);
			...
			if (lastLocation != null) {
				if (lastLocation.getLatitude() == location.getLatitude() && lastLocation.getLongitude() == location.getLongitude()) {
					LogUtils.error("map----same location, skip refresh");
