...
public class BaiduMapActivity extends BaseActivity {
	...
	private TitleBarView titleBarView;//标题
...
//        SDKInitializer.initialize(this.getApplication());
		...
		if (EasyPermissionsEx.hasPermissions(this,new String[]{Manifest.permission.LOCATION_HARDWARE,Manifest.permission.ACCESS_FINE_LOCATION})){
			EasyPermissionsEx.requestPermissions(BaiduMapActivity.this,"baidu",26,new String[]{Manifest.permission.LOCATION_HARDWARE,Manifest.permission.ACCESS_FINE_LOCATION,Manifest.permission.ACCESS_COARSE_LOCATION,Manifest.permission.ACCESS_LOCATION_EXTRA_COMMANDS});
		}
		titleBarView = (TitleBarView) findViewById(R.id.title_bar);
		titleBarView.setTitleText(R.string.location_message);
		titleBarView.setEnabled(false);
		titleBarView.setRightBtnOnclickListener(new View.OnClickListener() {
			@Override
	...
	private void showMap(double latitude, double longtitude, final String address) {
		titleBarView.setEnabled(false);
...
//			mMapView.onDestroy();
	...
	public class MyLocationListenner implements BDLocationListener {
		...
		public void onReceiveLocation(BDLocation location) {
			...
			titleBarView.setEnabled(true);
			titleBarView.setRightBtnText(R.string.send);
